        ...
        protected void AddBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "insert BookTb1 values('{0}',{1},{2},{3},{4})";
        ...
        protected void DeleteBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "delete BookTb1  where BId = {0}";
        ...
        protected void UpdateBtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string Query = "update BookTb1 set BName ='{0}',BAuthor = {1},BCategory = {2},BQty = {3},BPrice = {4} where BId = {5}";
