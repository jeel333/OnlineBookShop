...
<asp:Content ID="Content2" ContentPlaceHolderID="MyContent" runat="server">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
                    <label for="" class="form-label text-success">Aurhor Name</label>
                ...
                <div class="row">
                    ...
                    <div class="col d-grid">
                        <asp:Button Text="Update" runat="server" ID="EditSave" class="btn-warning btn-block btn" OnClick="EditSave_Click" />
                    </div>
                <div class="col d-grid">
